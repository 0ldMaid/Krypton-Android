...
public class krypton_database_search_new extends SQLiteOpenHelper {
    ...
    public krypton_database_search_new(){
    ...
    public String[][] search(){//**************************************************************************
        ...
        try {
            ...
            try {
                ...
                String query = ("SELECT id,title,price,currency,seller_address_country,item_search_1,item_search_2,item_search_3 FROM new_update ORDER BY xd DESC LIMIT 100");
